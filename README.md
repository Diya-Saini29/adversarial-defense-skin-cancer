...
│   ├── 07_adversarial_training.ipynb     # Blue-team defense (Defense 1)
│   └── 08_mdda_defense.ipynb             # MDDA defense (Defense 2, in progress)
│
├── src/
│   ├── models/
...
│   │   ├── fgsm.py
│   │   ├── pgd.py
│   │   └── spatial.py                    # Masked/partial/patch attacks
│   ├── defenses/
│   │   ├── adversarial_training.py       # Defense 1
│   │   └── mdda.py                       # Defense 2 (in progress)
│   ├── data/
